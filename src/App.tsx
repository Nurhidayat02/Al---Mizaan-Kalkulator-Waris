...
const HEIR_OPTIONS: { label: string; type: HeirType; gender: 'MALE' | 'FEMALE' }[] = [
  ...
  { label: 'Nenek dari Ayah', type: 'GRANDMOTHER_FATHER', gender: 'FEMALE' },
  { label: 'Nenek dari Ibu', type: 'GRANDMOTHER_MOTHER', gender: 'FEMALE' },
  { label: 'Cucu Laki-laki', type: 'GRANDSON', gender: 'MALE' },
  { label: 'Cucu Perempuan', type: 'GRANDDAUGHTER', gender: 'FEMALE' },
  { label: 'Cicit Laki-laki', type: 'GREAT_GRANDSON', gender: 'MALE' },
  ...
  { label: 'Keponakan Kandung (Laki-laki)', type: 'SON_BROTHER_GERMAN', gender: 'MALE' },
  { label: 'Keponakan Seayah (Laki-laki)', type: 'SON_BROTHER_FATHER', gender: 'MALE' },
  { label: 'Paman Kandung', type: 'UNCLE_GERMAN', gender: 'MALE' },
  { label: 'Paman Seayah', type: 'UNCLE_FATHER', gender: 'MALE' },
  { label: 'Sepupu Kandung (Laki-laki)', type: 'SON_UNCLE_GERMAN', gender: 'MALE' },
  { label: 'Sepupu Seayah (Laki-laki)', type: 'SON_UNCLE_FATHER', gender: 'MALE' },
  { label: 'Pembebas Budak (Laki-laki)', type: 'MU_TIQ', gender: 'MALE' },
  { label: 'Pembebas Budak (Perempuan)', type: 'MU_TIQAH', gender: 'FEMALE' },
];
